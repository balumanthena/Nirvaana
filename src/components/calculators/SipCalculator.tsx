            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-8 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none text-sm"
                        />
                    </div>
                    <input
                        type="range"
                        ...
                        value={monthlyInvestment}
                        onChange={(e) => setMonthlyInvestment(Number(e.target.value))}
                        className="w-full mt-2 accent-blue-600 h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer"
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none text-sm"
                        />
                ...
                <FadeIn delay={200} className="mt-6 pt-6 border-t border-slate-100 space-y-3">
                    ...
                    <div className="flex justify-between items-end pt-1">
                        <span className="text-base font-medium text-slate-900">Total Value</span>
                ...
                <div className="pt-4 flex flex-col gap-2.5">
                    <Link
                        href="/contact"
                        className="group flex items-center justify-center w-full px-6 py-2.5 bg-slate-900 text-white font-medium rounded-lg hover:bg-slate-800 transition-colors text-sm"
                    >
